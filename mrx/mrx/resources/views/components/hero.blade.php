        ...
        <div class="row gx-5 align-items-center">
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    ...
                    <h1 id="heroTitle" class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline"></span></h1>
...
<script>
    ...
    async function getHero(){
        try {
            ...
            document.getElementById("heroTitle").innerHTML=response.data['title'];
